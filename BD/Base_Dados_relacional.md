...
|--------------------|----------------------------------------|-------------------------------------|----------------------|
| Trabalhador_Porto  | superclasse de                          | Operador                             | 1:0..1               |
| Trabalhador_Porto  | superclasse de                          | Gestor                               | 1:0..1               |
| Gestor             | supervisiona                            | Turno                             | 1:N                  |
| *Gestor             |         gere                            | Cais                             | 1:N                  |
| *Gestor             |         altera                                 | Chegadas_Diarias                       | 1:N                  |
| Condutor           | conduz                                   | Camião                               | 1:N                  |
| Camião             | tem / regista                             | Chegadas_Diarias                     | 1:N                  |
| Chegadas_Diarias   | é encaminhada para                        | Cais                                 | N:1                  |
| Chegadas_Diarias   | pode gerar                                | Alerta                               | 1:N                  |
| Chegadas_Diarias   | referencia                                | Carga                                | N:1                  |
| Chegadas_Diarias   | está associada a                          | Camião                               | N:1                  |
| Chegadas_Diarias   | é acompanhada por                         | Operador                             | N:1                  |
| Cais               | recebe                                   | Chegadas_Diarias                     | 1:N                  |
| Carga              | pode gerar                                | Alerta                               | 1:N                  |
| Operador           | processa / valida                         | Deteções                              | 1:N                  |
...
| Turno              | regista                                   | Chegadas_Diarias                     | 1:N                  |
| Turno              | pode registar                             | Alerta                               | 1:N                  |
