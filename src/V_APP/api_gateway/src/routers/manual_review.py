...
async def produce_manual_review(  # NOSONAR
    ...
    license_plate: Annotated[str, Query(description="Detected license plate")],
    license_crop_url: Annotated[str, Query(description="License plate crop URL")] = "",
    un: Annotated[str, Query(description="UN number")] = "",
    kemler: Annotated[str, Query(description="Kemler code")] = "",
    hazard_crop_url: Annotated[str, Query(description="Hazard plate crop URL")] = "",
    route: Annotated[str, Query(description="Assigned route")] = "",
    decision: Annotated[str, Query(description="Decision: approved or rejected")] = ...,
    decision_reason: Annotated[str, Query(description="Reason for the decision")] = ...,
    alerts: Annotated[Optional[List[str]], Query(description="List of alerts")] = None,
    decision_source: Annotated[str, Query(description="Source of the decision")] = "operator",
    truck_id: Annotated[Optional[str], Query(description="ID of the truck, if available")] = None,
):
    """
