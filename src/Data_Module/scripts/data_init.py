...
def init_data(db: Session):
    ...
    try:
        ...
        # Insert demo appointments one at a time for correct arrival_id generation
        demo_appointments = []
        ...
        # Insert background appointments one at a time for correct arrival_id generation
        ...
        for i in range(background_count):
            ...
            db.add(appt)
            db.flush()
            background_appointments.append(appt)

        # Combine all appointments for reference
